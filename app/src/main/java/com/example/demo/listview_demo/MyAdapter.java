...
/**
 * Created by wuxiaolong on 2018/12/4.
 */
...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
       ...
       if (convertView == null){
           ...
           holder.name_tv = (TextView) convertView.findViewById(R.id.itm3_apkname);
           holder.des_tv = (TextView) convertView.findViewById(R.id.item3_apkdes);
           holder.info_tv = (TextView) convertView.findViewById(R.id.itm3_apkinfo);
